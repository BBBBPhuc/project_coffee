...
Route::post('/statusLogin', [APICustomerController::class, 'statusLogin'])->name('statusLogin');
...
Route::group(['prefix' => '/admin'], function () {
    ...
    Route::group(['prefix' => '/cham-cong'], function () {
        Route::post('/get-data', [APIChamCongController::class, 'layData'])->name('dataChamCong');
        Route::post('/create', [APIChamCongController::class, 'store'])->name('createChamCong');
        Route::post('/status', [APIChamCongController::class, 'status'])->name('statusChamCong');
        Route::post('/delete', [APIChamCongController::class, 'destroy'])->name('destroyChamCong');
    });
});
